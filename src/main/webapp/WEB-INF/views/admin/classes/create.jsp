        ...
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            <%@ taglib prefix="fn" uri="jakarta.tags.functions" %>
                ...
                <body>
                        ...
                        <div class="dashboard-body">
                            <div class="create-page">
                                ...
                                <div class="page-title">
                                    ...
                                    <p>Vui lòng điền đầy đủ các thông tin bên dưới để khởi tạo một khóa học mới trên hệ
                                        thống.</p>
                                </div>

                                <c:if test="${not empty error}">
                                    <div
                                        style="background: #fee2e2; color: #dc2626; padding: 14px; border-radius: 12px; margin-bottom: 20px; font-weight: 700; border: 1px solid #fecaca; display: flex; align-items: center; gap: 10px;">
                                        <span class="material-symbols-rounded">error</span>
                                        ${error}
                                    </div>
                                </c:if>

                                <form method="post" action="${pageContext.request.contextPath}/admin/classes/create"
                                    class="create-form">
                                    ...
                                    <div class="left-col">
                                        ...
                                        <section class="card">
                                            ...
                                            <div class="form-group full">
                                                ...
                                                <input type="text" name="className"
                                                    placeholder="Ví dụ: Anh Văn Giao Tiếp Cơ Bản A1" required>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="tuitionFeePerSession"
                                                        placeholder="2.500.000" min="0" required>
                                                </div>

                                                <div class="form-group">
                                                    <label>Số buổi học yêu cầu</label>
                                                    <input type="number" name="requiredSessionsPerMonth"
                                                        placeholder="24" min="1" required>
                                                </div>
                                            </div>
                                        ...
                                        <section class="card">
                                            <div class="student-head">
                                                <div class="card-title">
                                                    <span
                                                        class="title-icon purple material-symbols-rounded">group_add</span>
                                                ...
                                                <div class="student-tools">
                                                    <div class="student-search">
                                                        ...
                                                        <input type="text" id="studentSearch"
                                                            placeholder="Tìm học sinh..." onkeyup="filterStudents()">
                                                    </div>
                                                            ...
                                                            <c:forEach var="student" items="${students}">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="student-cell">
                                                                            <div class="avatar-mini">
                                                                                <c:choose>
                                                                                    <c:when
                                                                                        test="${not empty student.fullName}">
                                                                                        ${fn:substring(student.fullName,
                                                                                        0, 1)}
                                                                                    </c:when>
                                                                    ...
                                                                    <td>
                                                                        <c:choose>
                                                                            <c:when
                                                                                test="${not empty student.parent.phone}">
                                    ...
                                    <div class="right-col">
                                        ...
                                        <section class="card right-card-large">
                                            <div class="card-title">
                                                <span
                                                    class="title-icon cyan material-symbols-rounded">manage_accounts</span>
                                            ...
                                            <div class="search-select">
                                                ...
                                                <select name="tutorId" id="tutorSelect" required
                                                    onchange="showTutorInfo()">
                                                    <option value="">Chọn gia sư</option>

                                                    <c:forEach var="tutor" items="${tutors}">
                                                        <option value="${tutor.tutorId}" data-name="${tutor.fullName}"
                                                            data-phone="${tutor.phone}" data-email="${tutor.email}"
                                                            data-major="${tutor.major}" data-school="${tutor.school}"
                    ...
                    <script src="${pageContext.request.contextPath}/js/admin-class.js"></script>
