                ...
                <div class="filter-input">
                    <select name="subject">
                        ...
                        <c:forEach items="${subjects}" var="s">
                            <option value="${s}" ${param.subject == s ? 'selected' : ''}>${s}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
                ...
                <div class="filter-input">
                    <select name="grade">
                        ...
                        <c:forEach items="${grades}" var="g">
                            <option value="${g}" ${param.grade == g ? 'selected' : ''}>${g}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
                            ...
                            <div class="class-table-row">
                                ...
                                <div>
                                    ...
                                    <div class="class-code">
                                        #${empty clazz.classId ? '---' : clazz.classId}
                                    </div>
                                        ...
                                        <c:when test="${not empty clazz.tutor}">
                                            <div class="tutor-info">
                                                <div class="tutor-name">
                                                    <strong><c:out value="${not empty clazz.tutor ? clazz.tutor.fullName : 'Chưa rõ'}"/></strong>
                                                    <div style="font-size: 12px; color: var(--text-muted);">
                                                            <c:out value="${not empty clazz.tutor ? clazz.tutor.phone : ''}"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </c:when>
                                ...
                                <div class="actions-cell">
                                    <button type="button"
                                            class="action-btn"
                                            title="Xem chi tiết"
                                            onclick="goDetail(event, '${clazz.classId}')">
                                    ...
                                    <button type="button"
                                            ...
                                            onclick="toggleStatus(event, '${clazz.classId}')">
