                        ...
                        <section class="stats-grid">
                            <div class="stat-card">
                                ...
                                <div style="display: flex; gap: 8px; margin-top: 12px; font-size: 13px;">
                                    <span
                                        style="color: var(--success); font-weight: 700; display: flex; align-items: center;">
                            ...
                            <div class="stat-card">
                                ...
                                <div style="display: flex; gap: 8px; margin-top: 12px; font-size: 13px;">
                                    <span
                                        style="color: var(--warning); font-weight: 700; display: flex; align-items: center;">
                            ...
                            <div class="stat-card">
                                ...
                                <div style="display: flex; gap: 8px; margin-top: 12px; font-size: 13px;">
                                    <span
                                        style="color: var(--primary); font-weight: 700; display: flex; align-items: center;">
                                ...
                                <c:choose>
                                    <c:when test="${not empty parents}">
                                        <c:forEach items="${parents}" var="parent" varStatus="status">
                                            <c:set var="accountId" value="${parent.user.id}" />

                                            <div class="table-row" <c:if
                                                test="${empty parent.user or empty parent.user.id}">
                                                ...
                                                <div class="user-cell">
                                                    <c:choose>
                                                        <c:when test="${not empty parent.user.avatar
                                            and parent.user.avatar != 'default-avatar.png'
                                            and parent.user.avatar != 'avatar-default.png'}">
                                                    ...
                                                    <div class="user-detail">
                                                        <h4>${empty parent.fullName ? 'Chưa cập nhật' : parent.fullName}
                                                        </h4>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="subject-cell"
                                                    ...
                                                    <span style="font-weight: 700;">${empty parent.phone ? '---' :
                                                        parent.phone}</span>
                                                ...
                                                <div class="actions-cell">
                                                    <button type="button" class="action-btn" title="Xem chi tiết"
                                                        onclick="goDetail(event, '${parent.user.id}')">
                                                        <span class="material-symbols-rounded">visibility</span>
                                                    </button>

                                                    <button type="button" class="action-btn" title="Sửa"
                                                        onclick="goEdit(event, '${parent.user.id}')">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${parent.user.status}">
                                                            <button type="button" class="action-btn danger"
                                                                ...
                                                                onclick="lockUser(event, '${parent.user.id}')">
                                                        ...
                                                        <c:otherwise>
                                                            <button type="button" class="action-btn"
                                                                ...
                                                                onclick="unlockUser(event, '${parent.user.id}')">
                                    ...
                                    <div class="pagination-controls">
                                        <c:choose>
                                            <c:when test="${parentPage.number > 0}">
                                                <a href="<c:url value='/admin/parents?keyword=${param.keyword}&status=${param.status}&minChildren=${param.minChildren}&paymentStatus=${param.paymentStatus}&page=${parentPage.number - 1}' />"
                                                    class="btn-page">
                                            ...
                                            <c:choose>
                                                <c:when test="${total <= 7}">
                                                    <c:forEach begin="0" end="${total - 1}" var="p">
                                                        <a href="<c:url value='/admin/parents?keyword=${param.keyword}&status=${param.status}&minChildren=${param.minChildren}&paymentStatus=${param.paymentStatus}&page=${p}' />"
                                                ...
                                                <c:otherwise>
                                                    <a href="<c:url value='/admin/parents?keyword=${param.keyword}&status=${param.status}&minChildren=${param.minChildren}&paymentStatus=${param.paymentStatus}&page=0' />"
                                                    ...
                                                    <a href="<c:url value='/admin/parents?keyword=${param.keyword}&status=${param.status}&minChildren=${param.minChildren}&paymentStatus=${param.paymentStatus}&page=${total - 1}' />"
