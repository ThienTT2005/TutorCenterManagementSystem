...
<head>
    ...
    <title>Cập Nhật Hồ Sơ Phụ Huynh | TCMS Admin</title>
    ...
    <main class="main-content">
        ...
        <div class="profile-container">
            <div class="page-header">
                <h1>Hồ Sơ Phụ Huynh</h1>
                <p>Bước 2: Cập nhật thông tin chi tiết cho tài khoản mới.</p>
            </div>

            <form action="${pageContext.request.contextPath}/admin/users/${request.userId}/profile/parent" method="POST" enctype="multipart/form-data">
                <div class="form-card">
                    <h3><i class="fa-solid fa-user-shield"></i> Thông tin cá nhân</h3>
                    ...
                    <div class="profile-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fullName" class="form-input" placeholder="Nguyễn Văn B" value="${request.fullName}" required>
                        </div>
                        <div class="form-group">
                            <label>Số điện thoại <span style="color:red">*</span></label>
                            <input type="text" name="phone" class="form-input" placeholder="0912 345 678" value="${request.phone}" required>
                        </div>
                        <div class="form-group">
                            <label>Email <span style="color:red">*</span></label>
                            <input type="email" name="email" class="form-input" placeholder="parent@example.com" value="${request.email}" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group full-width">
                            ...
                            <input type="text" name="address" class="form-input" placeholder="456 Đường XYZ, Quận Y, TP. HCM" value="${request.address}">
                        </div>
                    </div>
