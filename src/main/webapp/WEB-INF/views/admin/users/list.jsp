                ...
                <main class="main-content">
                    ...
                    <div class="dashboard-body">
                        ...
                        <div class="page-header">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/users/create" class="btn-primary"
                                ...
                                <div class="filter-group">
                                    <div class="filter-input">
                                        <select name="role">
                                            ...
                                            <option value="TUTOR" ${param.role=='TUTOR' ? 'selected' : '' }>Gia sư
                                            </option>
                                            <option value="PARENT" ${param.role=='PARENT' ? 'selected' : '' }>Phụ huynh
                                            </option>
                                            <option value="STUDENT" ${param.role=='STUDENT' ? 'selected' : '' }>Học sinh
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="filter-group">
                                    <div class="filter-input">
                                        <select name="status">
                                            ...
                                            <option value="false" ${param.status=='false' ? 'selected' : '' }>Blocked
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty users}">
                                            <c:forEach items="${users}" var="user" varStatus="stt">
                                                ...
                                                <c:set var="roleName"
                                                    value="${not empty user.role ? user.role.roleName : ''}" />
                                                ...
                                                <div class="account-table-row">
                                                    ...
                                                    <div class="user-cell">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${not empty user.tutor}">
                                                                <c:set var="userAvatar" value="${user.tutor.avatar}" />
                                                            </c:when>
                                                            <c:when test="${not empty user.parent}">
                                                                <c:set var="userAvatar" value="${user.parent.avatar}" />
                                                            </c:when>
                                                            <c:when test="${not empty user.student}">
                                                                <c:set var="userAvatar"
                                                                    value="${user.student.avatar}" />
                                                            </c:when>
                                                        </c:choose>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${fn:startsWith(userAvatar, 'http')}">
                                                                <img src="${userAvatar}" class="user-initials"
                                                        ...
                                                        <div class="user-detail">
                                                            <h4>
                                                                <c:out
                                                                    value="${empty user.username ? 'Chưa cập nhật' : user.username}" />
                                                            </h4>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div style="display: flex; flex-direction: column; gap: 4px;">
                                                        <span
                                                            style="font-size: 13px; font-weight: 800; color: var(--text-dark);">
                                                            @
                                                            <c:out
                                                                value="${empty user.username ? 'unknown' : user.username}" />
                                                        </span>
                                                        <span
                                                            style="font-size: 12px; color: var(--text-muted); font-weight: 600;">
                                                            ID: #
                                                    ...
                                                    <div class="actions-cell">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${user.status == true}">
                                                                <button type="button" class="action-btn lock"
                                                            ...
                                                            <c:otherwise>
                                                                <button type="button" class="action-btn unlock"
