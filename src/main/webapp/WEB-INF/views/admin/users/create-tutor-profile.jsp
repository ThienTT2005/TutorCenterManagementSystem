...
<head>
    ...
    <title>Cập Nhật Hồ Sơ Gia Sư | TCMS Admin</title>
    ...
    <style>
        ...
        .form-input, .form-select, .form-textarea { width: 100%; padding: 12px 16px; background: #f8fafc; border: 1.5px solid var(--border-color); border-radius: 12px; font-size: 15px; font-weight: 600; outline: none; transition: all 0.3s; box-sizing: border-box; }
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="profile-container">
            ...
            <form action="${pageContext.request.contextPath}/admin/users/${request.userId}/profile/tutor" method="POST" enctype="multipart/form-data">
                <div class="form-card">
                    ...
                    <div class="profile-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fullName" class="form-input" placeholder="Nguyễn Văn A" value="${request.fullName}" required>
                        </div>
                        <div class="form-group">
                            <label>Số điện thoại <span style="color:red">*</span></label>
                            <input type="text" name="phone" class="form-input" placeholder="0901 234 567" value="${request.phone}" required>
                        </div>
                        <div class="form-group">
                            <label>Email <span style="color:red">*</span></label>
                            <input type="email" name="email" class="form-input" placeholder="tutor@example.com" value="${request.email}" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group full-width">
                            <label>Địa chỉ</label>
                            <input type="text" name="address" class="form-input" placeholder="123 Đường ABC, Quận X, TP. HCM" value="${request.address}">
                        </div>
                        <div class="form-group">
                            <label>Trường học</label>
                            <input type="text" name="school" class="form-input" placeholder="Đại học Sư Phạm" value="${request.school}">
                        </div>
                        <div class="form-group">
                            <label>Ngành học</label>
                            <input type="text" name="major" class="form-input" placeholder="Sư phạm Toán học" value="${request.major}">
                        </div>
                        <div class="form-group full-width">
                            <label>Mô tả bản thân</label>
                            <textarea name="description" class="form-textarea" rows="4" placeholder="Giới thiệu ngắn về kinh nghiệm giảng dạy...">${request.description}</textarea>
                        </div>
                    </div>
