...
<head>
    <meta charset="UTF-8">
    <title>Chi tiết lớp học | TCMS Student</title>
    ...
    <main class="class-detail-page">
        ...
        <section class="class-hero">
            <div class="hero-top">
                <div class="hero-title">
                    ...
                    <h1><c:out value="${empty classItem.className ? 'Chi tiết lớp học' : classItem.className}" /></h1>

                    <div class="hero-meta">
                        <span><i class="fa-solid fa-calendar-days"></i> ${empty sessions ? 0 : fn:length(sessions)} buổi học</span>
                        <span><i class="fa-solid fa-hashtag"></i> Mã lớp #<c:out value="${empty classItem.classId ? '' : classItem.classId}" /></span>
                    </div>
                ...
                <a href="${pageContext.request.contextPath}/student/classes" class="btn-back">
            ...
            <div class="quick-grid">
                <div class="quick-box"><span>Môn học</span><strong><c:out value="${empty classItem.subject ? '---' : classItem.subject}" /></strong></div>
                <div class="quick-box"><span>Khối lớp</span><strong><c:out value="${empty classItem.grade ? '---' : classItem.grade}" /></strong></div>
                <div class="quick-box"><span>Số buổi yêu cầu</span><strong>${empty classItem.requiredSessions ? 0 : classItem.requiredSessions} buổi</strong></div>
                <div class="quick-box"><span>Trạng thái</span><strong>${classItem.status == true ? 'Đang học' : 'Đã kết thúc'}</strong></div>
            </div>
        </section>
        ...
        <section class="layout">
            <div class="left-column">
                <div class="card">
                    <div class="card-body">
                        <h2 class="card-title"><i class="fa-solid fa-calendar-days"></i> Lịch học</h2>
                        <c:choose>
...
<%--                                               /student/homework/detail/{id}--%>
                            ...
                            <c:otherwise><div class="empty-card">Chưa có lịch học cho lớp này.</div></c:otherwise>
                        </c:choose>
                    </div>
                </div>
            </div>
            ...
            <aside class="right-column">
                <div class="card">
                    <div class="card-body">
                        <h2 class="card-title"><i class="fa-solid fa-chalkboard-user"></i> Gia sư phụ trách</h2>
                        <div class="tutor-card">
                            <div class="tutor-avatar">
                                <c:choose>
                                    ...
                                    <c:otherwise><i class="fa-solid fa-user-graduate"></i></c:otherwise>
                                </c:choose>
                            </div>
