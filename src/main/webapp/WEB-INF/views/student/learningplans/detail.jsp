    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        <%@ taglib prefix="fn" uri="jakarta.tags.functions" %>
            <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
                ...
                <head>
                    <meta charset="UTF-8">
                    <title>Kế hoạch bài giảng</title>
                        ...
                        <div class="dashboard-body">
                            <div class="page-wrap">
                                ...
                                <div class="breadcrumb">
                                    ...
                                    <span>›</span>
                                    <a href="${pageContext.request.contextPath}/student/classes">Lớp của tôi</a>
                                    <span>›</span>

                                    <c:choose>
                                        <c:when
                                            test="${not empty plan and not empty plan.session and not empty plan.session.classEntity}">
                                            <span>${plan.session.classEntity.className}</span>
                                        </c:when>
                                        <c:otherwise>
                                            <span>Kế hoạch bài giảng</span>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                                ...
                                <c:choose>
                                    <c:when test="${empty plan}">
                                        <div class="empty-card">
                                            ...
                                            <h2>Chưa có kế hoạch bài giảng</h2>
                                            ...
                                            <div class="title-box">
                                                <h1>
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${not empty plan.session.topic}">
                                                            ${plan.session.topic}
                                                        </c:when>
                                                        <c:otherwise>
                                                            Kế hoạch bài giảng
                                            ...
                                            <aside class="info-card">
                                                <div class="info-header">
                                                    ...
                                                    <h3>
                                                        <c:choose>
                                                            <c:when
                                                                test="${not empty plan.session.classEntity.className}">
                                                ...
                                                <div class="info-row">
                                                    ...
                                                    <div class="info-value">
                                                        <c:choose>
                                                            <c:when
                                                                test="${not empty plan.session.startTime and not empty plan.session.endTime}">
