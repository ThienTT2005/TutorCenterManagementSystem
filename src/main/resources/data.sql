...
-- Username: admin, Password: admin123 (mã hóa M5)
INSERT INTO users (username, password, role_id, status) VALUES
    ('admin', '$2a$10$.1Wu4hujUZJMb.rURbzGb.WWQ5T.uqBe/UHgQpcEdnimi/JIIW/ca', 1, TRUE);
...
GROUP BY c.class_id, c.class_name;DROP DATABASE IF EXISTS TCMS;
CREATE DATABASE TCMS CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE TCMS;
...
-- Tạo tài khoản ADMIN mặc định
-- Username: admin, Password: admin123 (mã hóa )
INSERT INTO users (username, password, role_id, status) VALUES
    ('admin', '$2a$10$.1Wu4hujUZJMb.rURbzGb.WWQ5T.uqBe/UHgQpcEdnimi/JIIW/ca', 1, TRUE);
